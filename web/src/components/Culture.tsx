 ...
 * block riding over its left edge. Authored in the CMS Landing page module.
 */
export default function Culture({ copy }: { copy: HomeCopy['culture'] }) {
  return (
      ...
      <div className="container-fluid pt-24 md:pt-32 pb-4 md:pb-5">
        <div className="relative">
          ...
          <motion.div
            ...
            className="relative overflow-hidden bg-bone lg:ml-[28%] aspect-[4/3] lg:aspect-[16/9]"
          >
            {copy.image && (
              <img
                src={copy.image}
