...
export const HOME_FALLBACK: HomeCopy = {
  ...
  services: {
    ...
    rows: [
      ...
      { title: 'Capital Markets', blurb: 'Equity issuance, follow-ons, and placements', href: '', image: '/Services 4.1.jpg' },
      { title: 'Advisory', blurb: 'Strategic and corporate finance counsel', href: '', image: '/Service 4.2.jpg' },
    ],
  },
  insights: {
    enabled: true,
  ...
  careers: {
    ...
    cta: { label: 'Answer your calling', href: '/careers' },
    image: '/CareersBG.png',
